...
{
	[Serializable]
    [DataContract(Name = "CompanyVendor", Namespace = "http://www.piistech.com//entities")]
	public partial class CompanyVendor : CompanyVendorBase
	{
		...
		{
			if (obj.GetType() != typeof(CompanyVendor))
            {
                return false;
            }			
			
			 CompanyVendor _paramObj = obj as CompanyVendor;
            if (_paramObj != null)
            {			
