...
{
	[Serializable]
    [DataContract(Name = "ProductVideo", Namespace = "http://www.piistech.com//entities")]
	public partial class ProductVideo : ProductVideoBase
	{
		...
		{
			if (obj.GetType() != typeof(ProductVideo))
            {
                return false;
            }			
			
			 ProductVideo _paramObj = obj as ProductVideo;
            if (_paramObj != null)
            {			
