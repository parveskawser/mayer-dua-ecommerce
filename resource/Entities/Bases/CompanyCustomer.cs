...
{
	[Serializable]
    [DataContract(Name = "CompanyCustomer", Namespace = "http://www.piistech.com//entities")]
	public partial class CompanyCustomer : CompanyCustomerBase
	{
		...
		{
			if (obj.GetType() != typeof(CompanyCustomer))
            {
                return false;
            }			
			
			 CompanyCustomer _paramObj = obj as CompanyCustomer;
            if (_paramObj != null)
            {			
