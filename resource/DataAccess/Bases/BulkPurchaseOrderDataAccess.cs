...
{
	public partial class BulkPurchaseOrderDataAccess : BaseDataAccess
	{
		#region Constants
		...
		protected void FillObject(BulkPurchaseOrderBase bulkPurchaseOrderObject, SqlDataReader reader, int start)
		{
				...
				bulkPurchaseOrderObject.ConsumedQuantity = reader.GetInt32( start + 14 );			
				bulkPurchaseOrderObject.ConsumedAmount = reader.GetDecimal( start + 15 );			
