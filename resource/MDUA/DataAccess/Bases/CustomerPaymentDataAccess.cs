...
{
	public partial class CustomerPaymentDataAccess : BaseDataAccess
	{
		#region Constants
		...
		protected void FillObject(CustomerPaymentBase customerPaymentObject, SqlDataReader reader, int start)
		{
				...
				if(!reader.IsDBNull(13)) customerPaymentObject.TransactionReference = reader.GetString( start + 13 );			
