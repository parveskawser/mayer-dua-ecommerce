...
namespace MDUA.Entities
{
	...
	public partial class Delivery : DeliveryBase
	{
		...
		private CompanyCarrier _CarrierIdObject = null;
		
		/// <summary>
		/// Gets or sets the source <see cref="CompanyCarrier"/>.
		/// </summary>
		/// <value>The source CompanyCarrier for _CarrierIdObject.</value>
		[DataMember]
		public CompanyCarrier CarrierIdObject
      	{
