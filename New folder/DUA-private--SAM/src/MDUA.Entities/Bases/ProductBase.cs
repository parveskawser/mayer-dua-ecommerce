...
namespace MDUA.Entities.Bases
{
	...
	public class ProductBase : BaseBusinessEntity
	{
		...
		public const string Property_ItemWeight = "ItemWeight";		            
		#endregion
		...
		private Nullable<Int32> _ItemWeight;	            
		#endregion
		...
		[DataMember]
		public Nullable<Int32> ItemWeight
		{	
			get{ return _ItemWeight; }			
			set
			{
				PropertyChangingEventArgs args = new PropertyChangingEventArgs(Property_ItemWeight, value, _ItemWeight);
				if (PropertyChanging(args))
				{
					_ItemWeight = value;
					PropertyChanged(args);					
		...
		public  ProductBase Clone()
		{
			...
			newObj.ItemWeight = this.ItemWeight;						
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue(ProductBase.Property_ItemWeight, ItemWeight);				
		}
		#endregion
