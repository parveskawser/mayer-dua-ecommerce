...

{
...

    {
        ...
        public int BackInStockRequestCount { get; set; }

        public List<BackInStockRequestSummary> BackInStockRequests { get; set; } = new List<BackInStockRequestSummary>();

    }

    public class BackInStockRequestSummary
    ...
    public class BackInStockRequestDetail
