...
namespace MDUA.Entities.Bases
{
	...
	public class ProductVariantBase : BaseBusinessEntity
	{
		...
		public const string Property_Weight = "Weight";		            
		#endregion
		...
		private Nullable<Int32> _Weight;	            
		#endregion
		...
		{	
			...
			set
			{
				PropertyChangingEventArgs args = new PropertyChangingEventArgs(Property_Weight, value, _Weight);
				if (PropertyChanging(args))
				{
					_Weight = value;
					PropertyChanged(args);					
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue(ProductVariantBase.Property_Weight, Weight);				
		}
		#endregion
