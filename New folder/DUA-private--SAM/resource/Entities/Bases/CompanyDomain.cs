...
{
	[Serializable]
    [DataContract(Name = "CompanyDomain", Namespace = "http://www.piistech.com//entities")]
	public partial class CompanyDomain : CompanyDomainBase
	{
		...
		{
			if (obj.GetType() != typeof(CompanyDomain))
            {
                return false;
            }			
			
			 CompanyDomain _paramObj = obj as CompanyDomain;
            if (_paramObj != null)
            {			
