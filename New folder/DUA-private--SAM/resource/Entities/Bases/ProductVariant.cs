...
{
	[Serializable]
    [DataContract(Name = "ProductVariant", Namespace = "http://www.piistech.com//entities")]
	public partial class ProductVariant : ProductVariantBase
	{
		...
		{
			if (obj.GetType() != typeof(ProductVariant))
            {
                return false;
            }			
			
			 ProductVariant _paramObj = obj as ProductVariant;
            if (_paramObj != null)
            {			
