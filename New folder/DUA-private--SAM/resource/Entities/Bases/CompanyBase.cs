...
namespace MDUA.Entities.Bases
{
	...
	public class CompanyBase : BaseBusinessEntity
	{
		...
		public const string Property_ThemeId = "ThemeId";		            
		public const string Property_ThemeSettings = "ThemeSettings";		            
		#endregion
		...
		private Nullable<Int32> _ThemeId;	            
		private String _ThemeSettings;	            
		#endregion
		...
		[DataMember]
		public Nullable<Int32> ThemeId
		{	
			get{ return _ThemeId; }			
			set
			{
				PropertyChangingEventArgs args = new PropertyChangingEventArgs(Property_ThemeId, value, _ThemeId);
				if (PropertyChanging(args))
				{
					_ThemeId = value;
					PropertyChanged(args);					
		...
		{	
			...
			set
			{
				PropertyChangingEventArgs args = new PropertyChangingEventArgs(Property_ThemeSettings, value, _ThemeSettings);
				if (PropertyChanging(args))
				{
		...
		public  CompanyBase Clone()
		{
			...
			newObj.ThemeId = this.ThemeId;						
			newObj.ThemeSettings = this.ThemeSettings;						
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue(CompanyBase.Property_ThemeId, ThemeId);				
			info.AddValue(CompanyBase.Property_ThemeSettings, ThemeSettings);				
		}
		#endregion
