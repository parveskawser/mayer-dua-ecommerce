...
{
	[Serializable]
    [DataContract(Name = "ProductSEO", Namespace = "http://www.piistech.com//entities")]
	public partial class ProductSEO : ProductSEOBase
	{
		...
		{
			if (obj.GetType() != typeof(ProductSEO))
            {
                return false;
            }			
			
			 ProductSEO _paramObj = obj as ProductSEO;
            if (_paramObj != null)
            {			
