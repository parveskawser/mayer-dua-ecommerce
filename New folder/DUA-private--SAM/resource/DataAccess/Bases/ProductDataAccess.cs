...
{
	public partial class ProductDataAccess : BaseDataAccess
	{
		#region Constants
		...
		{	
			...
			AddParameter(cmd, pInt32(ProductBase.Property_ItemWeight, productObject.ItemWeight));
		}
		#endregion
		...
		protected void FillObject(ProductBase productObject, SqlDataReader reader, int start)
		{
				...
				if(!reader.IsDBNull(16)) productObject.ItemWeight = reader.GetInt32( start + 16 );			
			FillBaseObject(productObject, reader, (start + 17));
