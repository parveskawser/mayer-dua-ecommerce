...
{
	public partial class ProductVariantDataAccess : BaseDataAccess
	{
		#region Constants
		...
		{	
			...
			AddParameter(cmd, pInt32(ProductVariantBase.Property_Weight, productVariantObject.Weight));
		}
		#endregion
		...
		protected void FillObject(ProductVariantBase productVariantObject, SqlDataReader reader, int start)
		{
				...
				if(!reader.IsDBNull(11)) productVariantObject.Weight = reader.GetInt32( start + 11 );			
			FillBaseObject(productVariantObject, reader, (start + 12));
