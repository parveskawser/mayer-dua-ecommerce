$(document).ready(function(){$(document).on("click",".js-expand-actions",function(){const t=$(this).data("product-id"),e=$("#drawer-"+t),a=$(this);$(".js-expand-actions").not(a).removeClass("btn-primary text-white").addClass("btn-manage"),$(".js-expand-actions").not(a).find("span").html("&#9660;"),$(".action-drawer-row").not(e).addClass("d-none"),e.toggleClass("d-none"),e.hasClass("d-none")?(a.removeClass("btn-primary text-white").addClass("btn-manage"),a.find("span").html("&#9660;")):(a.removeClass("btn-manage").addClass("btn-primary text-white"),a.find("span").html("&#9650;"))});let l=$('input[name="__RequestVerificationToken"]').val(),p=$("#modal-variants-content");const o=window.productConfig?window.productConfig.urls:{};(function(t){var e=t.ajax;t.ajax=function(a){var i=a.success;return a.success=function(n,d,s){if(n&&n.success===!1&&n.redirectUrl){window.location.href=n.redirectUrl;return}i&&i(n,d,s)},e(a)}})(jQuery);function g(t){let e=$(`tr[data-product-row-id="${t}"]`),a=e.find(".price-cell");e.length!==0&&$.get(o.getUpdatedPrice,{productId:t},function(i){if(i.success){let n="";i.hasDiscount?n=`<span class="original-price">${i.originalPrice}</span><br/>
                            <span class="discounted-price">${i.sellingPrice}</span>`:n=`<span>${i.originalPrice}</span>`,a.html(n)}})}function v(){let t=[];$(".attr-name-select").each(function(){let e=$(this).val();e&&t.push(e)}),$(".attr-name-select").each(function(){let e=$(this).val();$(this).find("option").each(function(){let a=$(this).val();a&&t.includes(a)&&a!==e?$(this).prop("disabled",!0):$(this).prop("disabled",!1)})})}function m(){let t=$("#dynamic-attributes-container .dynamic-attr-row").length,e=$("#attribute-template").html();(!e||e.trim()==="")&&(console.error("Attribute Template is empty. Ensure Facade loads Attributes."),e='<option value="">Error: No Attributes Found</option>');let a=`
