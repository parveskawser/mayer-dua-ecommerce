...
{
	[Serializable]
    [DataContract(Name = "ProductInventory", Namespace = "http://www.piistech.com//entities")]
	public partial class ProductInventory : ProductInventoryBase
	{
		...
		{
			if (obj.GetType() != typeof(ProductInventory))
            {
                return false;
            }			
			
			 ProductInventory _paramObj = obj as ProductInventory;
            if (_paramObj != null)
            {			
