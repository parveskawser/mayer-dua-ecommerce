...
namespace MDUA.DataAccess.Interface
{
	...
	public interface IPermissionGroupMapDataAccess : ICommonDataAccess<PermissionGroupMap, PermissionGroupMapList, PermissionGroupMapBase>
	{
        List<Permission> GetPermissionsByGroupId(int groupId);
