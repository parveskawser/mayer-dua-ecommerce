...
namespace MDUA.DataAccess.Interface
{
	...
	public interface IAddressDataAccess : ICommonDataAccess<Address, AddressList, AddressBase>
	{
        // Add this line
        Address GetLatestByCustomerId(int customerId);
        long InsertAddressSafe(Address address);
        // Add this line
        Address CheckExistingAddress(int customerId, Address newAddress);
        AddressList GetByCustomerId(int customerId);
    }	
}
